...
- [Примеры автоматизированных тест-кейсов](#примеры-автоматизированных-кейсов)
...
- [x] Поиск по гос. номеру автомобиля незарегистрированным/неавторизованным пользователем в каталоге
